<template>
  <div class="MyMessageMenu">
    <div class="menu">
      <div class="top">
        <div class="box1">
          <div class="icon iconbox1">
            <img
              class="img1"
              src="~assets/img/myMessage/menu/xiazai.png"
              alt=""
            />
          </div>
          <span>本地音乐</span>
        ...
        <div class="box1">
          <div class="icon iconbox1">
            <img
              class="img1"
              src="~assets/img/myMessage/menu/chenggong.png"
              alt=""
            />
          </div>
          <span>已购</span>
        ...
        <div class="box1" @click="myPlayed">
          <div class="icon iconbox1">
            <img
              class="img1"
              src="~assets/img/myMessage/menu/bofang.png"
              alt=""
            />
          </div>
          <span>最近播放</span>
      ...
      <div class="bottom">
        <div class="box2" @click="myFollow">
          <div class="icon">
            <img
              class="img2"
              src="~assets/img/myMessage/menu/guanzhu.png"
              alt=""
            />
          </div>
        ...
        <div class="box2" @click="myCollection">
          <div class="icon iconbox3">
            <img
              class="img3"
              src="~assets/img/myMessage/menu/shoucang.png"
              alt=""
            />
          </div>
        ...
        <div class="box2" @click="myRadioStation">
          <div class="icon iconbox4">
            <img
              class="img1"
              src="~assets/img/myMessage/menu/diantai.png"
              alt=""
            />
          </div>
          <span>我的电台</span>
        ...
        <div class="box2">
          <div class="icon iconbox3">
            <img
              class="img3"
              src="~assets/img/myMessage/menu/tianjia.png"
              alt=""
            />
          </div>
          <span class="text4">音乐应用</span>
        </div>
      </div>
    </div>
  </div>
